...
public class UserControllerTests {
    ...
    void register_validUserRequest_ResponseEntityOk() {
        ...
        expectedUserDto = UserDTO.createUserDTOFromUser(User.createUser("validEmail@gmail.com", "dsf$%f242", LoginMethod.PASSWORD_BASED));
    ...
    void setNotificationPreferences_UserExistsRequestValid_ResponseEntityResponseOk() {
        NotificationRequest notificationRequest = new NotificationRequest();
        expectedUserDto = UserDTO.createUserDTOFromUser(new User());
